...
class AddDataToPrograms
{
	public static void main(String[] args) throws SQLException, ClassNotFoundException, FileNotFoundException, IOException
	{
		try
		{
			...
			String[] javaFileName ={"TrickOrTreat", "SumOfDigits", "HiddenDigits", "LongestWords", "ReverseWords", "SplitTheNumber", "FizzBuzz" ,
								"RightMostChar", "RollerCoaster", "StepWiseWord", "Pangrams", "StringSearch", "DistinctSubsequence", 
								"SwapCase", "ReadMore", "ShortestRepeatations", "StackInterface", "ConsecutivePrime", "EmailValidation", 
								"JustifyTheText", "RobotMovements", "EggCrack", "AdvanceCalculator", "WorkingExperience", "StringRotation", 
			...
			if(resultSet.next())
			{
				...
				while(true)
				{
					...
					if(number != 0)
					{
						...
						{
							BufferedReader localBufferedReader = new BufferedReader(new FileReader("/home/jyoti/workspace/traineenov017/vertxproject/db/scripts/text/" + name[index]));
